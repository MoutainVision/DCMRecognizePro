...
#define XIMAGEJPG_SUPPORT_EXIF XIMAGE_SUPPORT_EXIF
...
#define EXIF_READ_ALL   0x03
		...
		public:
			...
			~CxExifInfo();
			bool DecodeExif(xFile * hFile, int32_t nReadMode = EXIF_READ_EXIF);
		...
		CxExifInfo* m_exif;
		bool DecodeExif(xFile * hFile);
		bool DecodeExif(FILE * hFile) { xIOFile file(hFile); return DecodeExif(&file); }
